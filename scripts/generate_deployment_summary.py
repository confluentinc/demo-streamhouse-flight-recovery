...
def generate_flink_sql_summary(
    ...
    output_path: Path,
    automated_commands: list | None = None,
    manual_commands: list | str | None = None,
    core_resources: list | None = None,
) -> None:
    """
    Generate a Flink SQL command summary markdown file for a lab.

    Args:
        lab_name: Name of the pipeline section
        cloud_provider: Cloud provider ("aws" or "azure")
        ...
        manual_commands: Either a markdown string OR list of dicts with 'title' and 'sql' keys
            for manual walkthrough steps
...
"""
        ...
        if core_resources:
            ...
            content += "The following LLM connections and models were created in Core Terraform and are used by the demo:\n\n"
